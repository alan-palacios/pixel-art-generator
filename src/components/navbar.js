...
function Navbar(props) {
  ...
  return (
    <div className="w-full bg-gray-90 text-gray-10 h-14 fixed top-0 md:p-2 flex z-10">
      <span className="m-auto ml-5 text-lg md:text-2xl font-tysla">Pixel art generator</span>
