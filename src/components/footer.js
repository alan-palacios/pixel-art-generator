...
function Footer() {
  return (
    <div className="w-full bg-gray-90 text-gray-10 h-16 md:h-16 xl:h-10 fixed bottom-0 pt-2 flex md:flex-col font-montserrat-m text-sm md:text-base">
      <div className="flex  fixed inset-x-0 xl:bottom-2 w-max m-auto">
      ...
      <div className="pb-2 px-5 hidden md:flex m-auto mb-0 w-full">
        <a href="https://github.com/alan-palacios/pixel-art-generator" target="_blank" rel="noreferrer" className="m-auto ml-0">
